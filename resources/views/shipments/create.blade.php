<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md"
        ...
        <form action="{{ route('shipments.store') }}" method="POST">
            ...
            <h3 class="text-lg font-semibold text-gray-800 border-b pb-2 mb-6">Informasi Pengiriman</h3>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label for="driver_id" class="block mb-2 text-sm font-medium text-gray-700">Pilih Driver</label>
                ...
                <div>
                    ...
                    <input type="datetime-local" id="departure_time" name="departure_time" value="{{ date('Y-m-d\TH:i') }}" required
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>
            </div>
            ...
            <div class="mb-6">
                <div class="flex justify-between items-center mb-2">
                    <label class="block text-sm font-medium text-gray-700">Tujuan Sekolah & Muatan</label>
                ...
                <p class="mt-2 text-xs text-gray-500">* Pastikan urutan tujuan sesuai rute pengiriman yang diinginkan.</p>
            </div>
